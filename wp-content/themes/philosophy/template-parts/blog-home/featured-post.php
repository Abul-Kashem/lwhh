                    ...
                    <div class="entry"
                        ...
                        <div class="entry__content">
                            <span class="entry__category"><a
                                        href="<?php echo esc_url( $post_data[0]['cat_link'] ); ?>"><?php echo esc_html( $post_data[0]['single_category'] ); ?></a></span>

                            <h1><a href="<?php echo esc_url( $post_data[0]['permalink'] ); ?>"
                                   title="<?php echo esc_html( $post_data[0]['title'] ); ?>"><?php echo esc_html( $post_data[0]['title'] ); ?></a></h1>

                            <div class="entry__info">
                                <a href="<?php echo esc_url( $post_data[0]['author_url'] ); ?>"
                ...
                <div class="featured__column featured__column--small">
					...
					for ( $i = 1; $i < 3; $i ++ ):
                        ...
                        <div class="entry"
                            ...
                            <div class="entry__content">
                                <span class="entry__category"><a
                                            href="<?php echo esc_url( $post_data[ $i ]['cat_link'] ); ?>"><?php echo esc_html( $post_data[ $i ]['single_category'] ); ?></a></span>

                                <h1><a href="<?php echo esc_url( $post_data[ $i ]['permalink'] ); ?>"
                                       title="<?php echo esc_html( $post_data[ $i ]['title'] ); ?>"><?php echo esc_html( $post_data[ $i ]['title'] ); ?></a></h1>

                                <div class="entry__info">
                                    <a href="<?php echo esc_url( $post_data[$i]['author_url'] ); ?>" class="entry__profile-pic">
                                        <img class="avatar"
                                             src="<?php echo esc_url( $post_data[ $i ]['author_avatar'] ); ?>"
                                             alt="<?php echo esc_html( $post_data[$i]['author'] ); ?>">
                                    </a>
