...
function philosophy_assets() {
	wp_enqueue_style( "font-awesome-css", get_theme_file_uri( "/assets/font-awesome/css/font-awesome.min.css" ), null, "1.0" );
	wp_enqueue_style( "fonts-css", get_theme_file_uri( "/assets/fonts.css" ), null, "1.0" );
...
function philosophy_widgets() {
	...
	register_sidebar( array(
		'name'          => __( 'Before Footer Right Widget', 'philosophy' ),
		'id'            => 'before-footer-right-widget',
		'description'   => __( 'Before right widget', 'philosophy' ),
		'before_widget' => '<div id="%1$s" class="col-block %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3>',
		'after_title'   => '</h3>',
	...
	register_sidebar( array(
		'name'          => __( 'Header Social Widget', 'philosophy' ),
		'id'            => 'header-social-widget',
		'description'   => __( 'Header Social Widget', 'philosophy' ),
		'before_widget' => '<div id="%1$s" class="%2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h3>',
		'after_title'   => '</h3>',
...
function philosophy_cpt_slug_fix( $post_link, $id ) {
	$p = get_post( $id );
	if ( is_object( $p ) && 'chapter' == get_post_type() ) {
...
add_filter( 'post_type_link', 'philosophy_cpt_slug_fix', 1, 3 );
