...
<section class="s-extra">
    ...
    <div class="row top">
        ...
        <div class="col-four md-six tab-full about">
			<?php
			if ( is_active_sidebar( "before-footer-right-widget" ) ) {
				dynamic_sidebar( "before-footer-right-widget" );
			}
			?>
    ...
    <div class="s-footer__main">
        <div class="row">
            ...
            <div class="col-two md-four mob-full s-footer__archives">
				...
				<?php
				$footer_middle_menu = wp_nav_menu(
					array(
						'theme_location' => 'footer-left',
						'menu_id'        => '',
						'menu_class'     => 's-footer__linklist',
				...
				echo wp_kses_post( $footer_middle_menu);
				?>
